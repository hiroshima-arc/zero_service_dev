...
var bootstrap = (function(t, e) {
  ...
  function v(t, e) {
    ...
    return (
      (n ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (d = u(d, e)), d
    );
  }
  function E(t) {
              ...
              (f.show = function() {
                ...
                if (
                  ...
                  if (
                    ...
                    if (
                      (e(this._element).trigger(l), !l.isDefaultPrevented())
                    ) {
                      r &&
  ...
  var st =
    ...
    lt = function() {
      return (
        void 0 === at && (at = -1 !== navigator.appVersion.indexOf("MSIE 10")),
        at
      );
    },
    ct = function(t, e) {
          ...
          return (
            ...
            (c._getConfig = function(n) {
              if ("string" != typeof (n = e.extend({}, i, n)).target) {
                ...
                o || ((o = X.getUID(t)), e(n.target).attr("id", o)),
                  (n.target = "#" + o);
              }
          ...
          return (
            ...
            (o._activate = function(t, n, o) {
              var s,
                ...
                c =
                  o && X.supportsTransitionEnd() && l && e(l).hasClass(i.FADE),
                f = function() {
